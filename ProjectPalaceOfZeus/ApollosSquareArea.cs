...
namespace ProjectPalaceOfZeus
{
    public partial class ApollosSquareArea : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.apollossquare;
        ...
        private void ApollosSquareArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void ApollosSquareArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(1, 2);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
