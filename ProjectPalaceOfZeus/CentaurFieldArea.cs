...
namespace ProjectPalaceOfZeus
{
    public partial class CentaurFieldArea : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.livadiarea;
        ...
        private void CentaurFieldArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void CentaurFieldArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(3, 0);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
