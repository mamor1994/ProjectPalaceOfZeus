...
namespace ProjectPalaceOfZeus
{
    public partial class HelensSpaArea : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.spaarea;
        ...
        private void HelensSpaArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void HelensSpaArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(0, 2);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
