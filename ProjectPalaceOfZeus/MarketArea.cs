...
{
    public partial class MarketArea : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {   BackgroundImage = Properties.Resources.marketarea1;
        ...
        private void MarketArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void MarketArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(0, 0);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
