...
{
    public partial class EntranceArea : Form
    {
        ...
        private void EntranceArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void EntranceArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(1, 4);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
