...
namespace ProjectPalaceOfZeus
{
    ...
    public partial class ParkingArea2 : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.parkingarea2;
        ...
        private void ParkingArea2_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void ParkingArea2_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(2, 4);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
