...
{
    public partial class ForestArea : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.forestarea;
        ...
        private void ForestArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void ForestArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(3, 2);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
