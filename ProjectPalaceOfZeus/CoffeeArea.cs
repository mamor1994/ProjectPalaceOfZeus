...
{
    public partial class CoffeeArea : Form
    {
        ...
        private void ToTRHorsePictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                BackgroundImage = Properties.Resources.coffeearea;
        ...
        private void CoffeeArea_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void CoffeeArea_MouseClick(object sender, MouseEventArgs e)
        {
            if (clickableArea.Contains(e.Location))
            {
                ...
                {
                    TrojanHorse trojanHorse = new TrojanHorse(2, 2);
                    trojanHorse.Show();
                    this.Hide();
                }
            }
